...
import profilePic from "../assets/projects/charanprofilepic.jpeg"
...
const Hero = () => {
  return (
    <div className=' border-b bg-neutral-900 pb-4 lg:mb-35'>
        <div className=" flex flex-wrap">
            <div className=" w-full lg:w-1/2">
                <div className=" flex flex-col items-center lg:items-start">
                    ...
                    initial="hidden"
                    animate="visible" 
                    className=' pb-16 text-4xl font-thin tracking-tight lg:mt-16 lg:text-5xl'>DEVI CHARAN DESABOYINA </motion.h1>
                    <motion.span 
